...
class MyCronJob(CronJobBase):
    ...
    def do(self):
        ...
        # tweets = 400 # 100 downward/latest
        # res = [int(id.strip()) for id in result[tweets+1:tweets+6]] # list comprehension

        # for id in res:
        #     tweets_id = HackerNewsID(hackertweets=id)
        #     tweets_id.save()

        print("Cron job start...")
        # internal endpoint that refresh & update the data for list of tweets by its term
        NEWS_URL = 'http://localhost:8080/api/v1/tweets'
